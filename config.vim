...
function! ExecuteByFileExtension()
  " TODO: replace this by the if statement for selecting the right make.
  " For example when I am working with C program run the make file instead of ruby.
  set makeprg='!ruby %'
endfunction

" Execute current buffer as ruby
map <S-r> :call ExecuteByFileExtension()<CR>
...
au BufNewFile,BufRead *.tsx set ft=js
au BufNewFile,BufRead *.coffee set ft=coffee
au BufNewFile,BufRead *.yaml.j2 set ft=jinja
au BufNewFile,BufRead *.hql.j2 set ft=sql
